...
/**
 * PositionTypeController implements the CRUD actions for PositionType model.
 */
class PositionTypeController extends Controller
{
    ...
    /**
     * Displays a single PositionType model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new PositionType model.
    ...
    /**
     * Updates an existing PositionType model.
    ...
    /**
     * Deletes an existing PositionType model.
